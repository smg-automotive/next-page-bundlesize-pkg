...
npx next-page-bundlesize --maxSize="150 kB"
```
...
| --buildDir               | Directory containing the output from `npx next experimental-analyze --output`.                                                                                                                                                                                                                                                   | ".next/diagnostics/analyze" when present, otherwise ".next" |
